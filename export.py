...
parser.add_argument('profile', type=str,
                    help='base-model | reentrance-model | no-shared-code-model | no-zipfian-model | single-exemplar-model | no-reduction-model')
...
if args.profile not in list(PROFILES.keys()):
    raise ValueError("Unknownp rofile")
...
for graph_name in graphs:
    filename = "".join(["fig-", args.profile, "-", graph_name, ".png"])
