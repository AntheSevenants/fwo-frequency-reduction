...
Another interesting effect concerns the reorganisation of acoustic energy in the different representations. It seems like the Zipfian frequency curve naturally leads reduction to reorganise the linguistic system in the most efficient way; the most frequent constructions take up the most basic acoustic representations with the least amount of energy, while less frequent constructions are expressed with more elaborate acoustic representations.
