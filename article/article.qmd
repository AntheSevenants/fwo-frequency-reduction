...
Furthermore, our model currently does not account for the co-existence of reduced and unreduced forms. While our exemplar model allows for a wide range of variation, agents will forget older, in our case unreduced forms once they fill up their exemplar memories. It is difficult, then, for *I don't know* and *dunno* to co-exist. Other possible extensions include allowing constructions to disappear or varying the 'reducibility' of certain constructions to account for the fact that not *all* high frequency words seem eligible for reduction.
