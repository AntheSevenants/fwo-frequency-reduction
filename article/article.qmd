...
10. **Communicative success (macro average):**  
  ...
  $$
  \frac{1}{V} \sum_{c=1}^{V}{\frac{\text{\# successful turns}}{\text{\# turns for construction } c}}
  $$
4. **Average acoustic strength in agents' memories:**  
  Number expressing for each construction $c$ the average acoustic strength in its distributions, across all agents.
  $$
  \frac{1}{N} \sum_{i=1}^{N}{\left[ \frac{1}{V} \sum_{c=1}^{V}{ \left[ \frac{1}{D} \sum_{j=1}^{D}{\mu_{i,c,j}} \right] } \right]}
  $$
6. **Confusion matrix:**  
