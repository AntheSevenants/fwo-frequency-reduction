...
[^frequency-truncation]: For the frequency distribution of these ten items, we use the first ten frequencies from the larger, 100-construction Zipfian distribution found in the base model. A Zipfian decay over just ten constructions would not make much sense, and would also make it harder to demonstrate the cause of confusion.
