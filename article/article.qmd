...
In addition, though some tradeoff between communicative effort and communicative success is to be expected, it is imperative that communication between agents remains successful. If the language system has reorganised itself in a way that makes effective communication impossible, 
