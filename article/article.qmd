...
10. **Communicative success (macro average):**  
  ...
  $$
  \frac{1}{V} \sum_{t=1}^{V}{\text{communicative success for construction }t }
  $$
11. **Good origin ratio:**  
  Ratio expressing for each construction $t$ how many exemplars originate in successful speaking turns.  
  $$
