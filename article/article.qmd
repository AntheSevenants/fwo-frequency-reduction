...
![A flattened representation of the exemplar locations of a random agent in the cone model (starting situation, 0 iterations).](figures/fig-cone-model-angle-vocabulary-plot-2d-begin.png){#fig-cone-model-angle-vocabulary-plot-2d-begin}

![A flattened representation of the exemplar locations of a random agent in the cone model (700 iterations).](figures/fig-cone-model-angle-vocabulary-plot-2d-end.png){#fig-cone-model-angle-vocabulary-plot-2d-end}
