...
The Zipfian frequency distribution has a notoriously long tail in the lower-frequency regions, which is difficult to compress into a limited number of constructions (see @sec-parameters). Therefore, the frequency values for our $V$ constructions are sampled from a much larger distribution with $S$ constructions. The sampling procedure works as follows:

1. Generate a Zipfian distribution of size $S$
2. Sample $V$ constructions of the large distribution with size $S$ with Zipfian weights. Take the absolute frequencies of the sampled constructions.
3. Assign the construction choice probabilities based on the sampled frequencies.

With this sampling procedure, our limited construction set aligns more with the properties of a typical, larger Zipfian distribution.
...
![Average L1 value in the base model (per construction, across agents, 100,000 iterations). The x axis shows each construction from most frequent to less frequent.](figures/fig-base-model-l1-per-construction.png){#fig-base-model-l1-per-construction}

![Average L1 half life in the base model (per construction, across agents, 100,000 iterations). The x axis shows each construction from most frequent to less frequent.](figures/fig-base-model-half-life-per-construction.png){#fig-base-model-half-life-per-construction}
...
![Average L1 value in the re-entrance model (per construction, across agents, 100,000 iterations). The x axis shows each construction from most frequent to less frequent.](figures/fig-reentrance-model-l1-per-construction.png){#fig-reentrance-model-l1-per-construction}

![Average L1 half life in the re-entrance model (per construction, across agents, 100,000 iterations). The x axis shows each construction from most frequent to less frequent.](figures/fig-reentrance-model-half-life-per-construction.png){#fig-reentrance-model-half-life-per-construction}
...
![Average L1 value in the uniform distribution model (per construction, across agents, 100,000 iterations). The x axis shows each construction starting from the originally Zipfian rank 1.](figures/fig-no-zipfian-model-l1-per-construction.png){#fig-no-zipfian-model-l1-per-construction}

![Average L1 half life in the uniform distribution model (per construction, across agents, 100,000 iterations). The x axis shows each construction starting from the originally Zipfian rank 1.](figures/fig-no-zipfian-model-half-life-per-construction.png){#fig-no-zipfian-model-half-life-per-construction}
...
![Average L1 value in the uniform distribution model with feedback (per construction, across agents, 100,000 iterations). The x axis shows each construction starting from the originally Zipfian rank 1.](figures/fig-no-zipfian-model-feedback-l1-per-construction.png){#fig-no-zipfian-model-feedback-l1-per-construction}

![Average L1 half life in the uniform distribution model with feedback (per construction, across agents, 100,000 iterations). The x axis shows each construction starting from the originally Zipfian rank 1.](figures/fig-no-zipfian-model-feedback-half-life-per-construction.png){#fig-no-zipfian-model-feedback-half-life-per-construction}
