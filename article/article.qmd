...
We explained in @sec-evaluation that the key point of simulation research is the search for the minimal set of conditions that produces a specific effect. This is our current minimal set which is conducive to the reducing effect: 
...
In this article, we attempted to find the minimal conditions necessary to produce the reducing effect as described by @bybee_usage_2006. We found that at least the following set of specifications was required to lead to the reducing effect:
