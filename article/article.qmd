...
3. The exemplar heard is saved in the hearer's memory and is associated with the understood construction. The speaker does not adapt their own memory to keep the model design as simple as possible.
