...
We saw that both ambiguity avoidance mechanisms we tested, discriminatory force and re-entrance, performed similarly. While re-entrance has the advantage of avoiding more failed communicative turns, its vague definition (it can either apply during speech production, or after failed communication) makes it less stable theoretically. This issue does not arise with discriminatory force, though this mechanism has slightly worse performance in our simulations. A more elaborate simulation architecture is needed to better compare these mechanisms.
