...
For completeness' sake, we also show in @fig-re-entrance-ctx_energy_mean that more frequent constructions display starker reduction than less frequent constructions, just as is expected for the reducing effect: since higher frequency constructions receive more practice, their reduction is stronger than for lower frequency constructions.
