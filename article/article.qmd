...
![Average L1 evolution in the base model (across constructions, across agents)](figures/fig-base-model-l1-general.png){#fig-base-model-l1-general}

![Average L1 value in the base model (per construction, across agents, 50,000 iterations)](figures/fig-base-model-l1-per-construction.png){#fig-base-model-l1-per-construction}

![Average L1 half life in the base model (per construction, across agents, 50,000 iterations)](figures/fig-base-model-half-life-per-construction.png){#fig-base-model-half-life-per-construction}
...
![Confusion matrix showing the mistakes that agents make in the base model. The y axis shows the intended constructions, the x axis shows the understood construction (across agents).](figures/fig-base-model-matrix.png){#fig-base-model-matrix}
...
![Average L1 evolution in the re-entrance model (across constructions, across agents)](figures/fig-reentrance-model-l1-general.png){#fig-reentrance-model-l1-general}

![Average L1 value in the re-entrance model (per construction, across agents, 50,000 iterations)](figures/fig-reentrance-model-l1-per-construction.png){#fig-reentrance-model-l1-per-construction}

![Average L1 half life in the re-entrance model (per construction, across agents, 50,000 iterations)](figures/fig-reentrance-model-half-life-per-construction.png){#fig-reentrance-model-half-life-per-construction}
...
![Average L1 value in the re-entrance model with Zipfian sampling (per construction, across agents, 50,000 iterations)](figures/fig-reentrance-model-l1-per-construction.png){#fig-base-model-l1-per-construction-repeat}

![Average L1 value in the re-entrance model with linear sampling (per construction, across agents, 50,000 iterations)](figures/fig-no-zipfian-model-l1-per-construction.png){#fig-no-zipfian-model-l1-per-construction}
...
![Average L1 half life in the re-entrance model with Zipfian sampling (per construction, across agents, 50,000 iterations)](figures/fig-reentrance-model-half-life-per-construction.png){#fig-bases-model-half-life-per-construction-repeat}

![Average L1 half life in the with linear sampling (per construction, across agents, 50,000 iterations)](figures/fig-no-zipfian-model-half-life-per-construction.png){#fig-no-zipfian-model-half-life-per-construction}
