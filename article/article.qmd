...
This entails that high frequency constructions reduce at a faster rate [@bybee_phonology_2003], and as a result experience more severe reduction compared to low-frequency constructions. The reason for the reduction process itself is so-called "neuromotor automation", according to @bybee_usage_2006 [5].
