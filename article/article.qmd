...
Another option avoids ambiguity on behalf of the speaker. "Re-entrance", coined by @steels_language_2003, can be understood as the application of a speaker's reception subsystem to their own linguistic utterances, to serve as a means of incomprehension prevention or repair. Re-entrance is mechanically straightforward: a speaker's intended production is routed through their own reception mechanism, and its adequacy is subsequently assessed. More straightforwardly, if a speaker cannot understand themselves as the result of a sound change, they reverse that change. In contrast to discriminatory force, this mechanism thus avoids ambiguity at speech time by making an estimation of the hearer's interpretation, through a projection of the speaker themselves.

The advantage of ambiguity avoidance on behalf of the speaker is that it is conceptually straightforward

- speaker: straightforward, prevents "odd" forms from potentially derailing a system in the first place; cognitive underpinnings are more theoretical, application to reduction is theoretically ambiguous
- hearer: does not prevent odd forms from existing, but does prevent them from derailing a system, theoretically better underpinned, compatible with reduction
...
TODO @hartsuiker_error_2001: correctie *na* uitspraak, @ferreira_how_2005: detectie *voor* uitspraak
wij zijn agnostisch hoe de correctie gebeurt, maar correctie kan zeker
